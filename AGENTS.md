...
3. Ensure all git commands are reversible.
4. At the beginning of each session ask for permission to run git commands, then don't ask tell the next session.
5. Always plan first before executing.
...
8. After each feature push to github git add ., git commit -m "feature name", git push
